  ...
  return (
    <ark.button
      className={cn(buttonVariants({
        ...
        size: "icon-xs",
        clickEffect: false,
      }), "absolute inset-e-3 top-3.5", "text-sidebar-foreground", "transition-transform", "hover:bg-sidebar-accent hover:text-sidebar-accent-foreground", "[&_svg]:size-4 [&_svg]:shrink-0", "after:absolute after:-inset-2 md:after:hidden", "group-data-[collapsible=icon]:hidden", "motion-reduce:transition-none!", className)}
...
export const SidebarMenuAction = (props) => {
  ...
  return (
    <ark.button
      className={cn(buttonVariants({
        ...
        size: "icon-xs",
        clickEffect: false,
      }), "absolute inset-e-1 top-1.5", "text-sidebar-foreground", "transition-transform", "hover:bg-sidebar-accent hover:text-sidebar-accent-foreground", "peer-hover/menu-button:text-sidebar-accent-foreground", "after:absolute after:-inset-2 md:after:hidden", "peer-data-[size=lg]/menu-button:top-2.5 peer-data-[size=md]/menu-button:top-1.5 peer-data-[size=sm]/menu-button:top-1", "group-data-[collapsible=icon]:hidden", "[&_svg]:size-4 [&_svg]:shrink-0", !showOnHover &&
        "group-focus-within/menu-item:opacity-100 group-hover/menu-item:opacity-100 data-[state=open]:opacity-100 peer-data-[active=true]/menu-button:text-sidebar-accent-foreground md:opacity-0", "motion-reduce:transition-none!", className)}
...
export const SidebarMenuSkeleton = (props) => {
...
export const SidebarMenuSub = (props) => {
  const { className, ...rest } = props;
