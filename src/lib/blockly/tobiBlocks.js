...
export const tobiBlocks = {
	...
	tobi_tail_wag: {
		init() {
			this.appendDummyInput().appendField("mover cola");
			this.setPreviousStatement(true, null);
			this.setNextStatement(true, null);
			this.setStyle("posture_blocks");
	...
	tobi_when_start: {
		init() {
			this.appendDummyInput().appendField("al ejecutar");
			this.setNextStatement(true, null);
	...
	tobi_while: {
		init() {
			this.appendValueInput("CONDITION").setCheck("Boolean").appendField("mientras");
			this.appendStatementInput("DO").appendField("hacer");
			this.setPreviousStatement(true, null);
			this.setNextStatement(true, null);
			this.setStyle("control_blocks");
	...
	contents: [
		{
			...
			colour: "#f5a623",
			contents: [{ kind: "block", type: "tobi_when_start" }],
		},
		{
			kind: "category",
			name: "Movimiento",
